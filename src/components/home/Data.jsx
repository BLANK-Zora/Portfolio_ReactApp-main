...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Param Saxena
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I am a creative Front end developer based in Delhi-NCR,
                I am very passionate and dedicated to my work.</p>
