...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_3nzqkf7', 'template_lgc4obq', form.current, {
                publicKey: 'PRVl4b8c3sMN8t0e6',
            })
        e.target.reset();
    };
    return (
            ...
            <div className="contact__container container grid">
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        {/* duplicate this for adding more info */}
                        <div className="contact__card">
                            <i className="bx bx-mail-send contact__card-icon"></i>
                            <h3 className="contact__card-title">Email</h3>
                            <span className="contact__card-data">param.saxena1717@gmail.com</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">el._.catto</span>
                            {/* <a href="#contact" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a> */}
                        </div>
                    </div>
                </div>
